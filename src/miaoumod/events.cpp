...
lua::event< std::tuple<int, const char *, const char *, const char *> >  event_connecting("connecting");
lua::event< std::tuple<int> >                                      event_connect("connect");
lua::event< std::tuple<int> >                                      event_disconnect("disconnect");
lua::event< std::tuple<const char *> >                             event_failedconnect("failedconnect");
...
lua::event< std::tuple<int,int,int> >                              event_reteam("reteam");
lua::event< std::tuple<int,int,int> >                              event_chteamrequest("chteamrequest");
...
lua::event< std::tuple<int,const char *,const char *> >            event_authreq("request_auth_challenge");
...
lua::event< std::tuple<> >                                         event_clearbans_request("clearbans_request");
...
lua::event< std::tuple<> >                                         event_beginrecord("beginrecord");
lua::event< std::tuple<> >                                         event_endrecord("endrecord");
...
lua::event< std::tuple<> >                                         event_reloadmiaoumod("reloadmiaoumod");
