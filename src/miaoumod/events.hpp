#ifndef MIAOUMOD_EVENTS_HPP
#define MIAOUMOD_EVENTS_HPP
...
extern lua::event< std::tuple<int, const char *, const char *, const char *> >  event_connecting;
extern lua::event< std::tuple<int> >                                      event_connect;
extern lua::event< std::tuple<int> >                                      event_disconnect;
extern lua::event< std::tuple<const char *> >                             event_failedconnect;
...
extern lua::event< std::tuple<int,int,int> >                              event_reteam;
extern lua::event< std::tuple<int,int,int> >                              event_chteamrequest;
...
extern lua::event< std::tuple<int,const char *,const char *> >            event_authreq;
...
extern lua::event< std::tuple<> >                                         event_clearbans_request;
...
extern lua::event< std::tuple<> >                                         event_beginrecord;
extern lua::event< std::tuple<> >                                         event_endrecord;
...
extern lua::event< std::tuple<int, const char *, int> >                   event_scoreflag;
...
extern lua::event< std::tuple<> >                                         event_reloadmiaoumod;
